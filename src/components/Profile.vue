<template>
        ...
        <el-card class="box-card" style="width: 600px">
            <template #header>
                <div class="card-header">
                    <el-text class="title" style="font-size: 20px; color: #409eff">
                        <h4>个人信息</h4>
                    </el-text>
                </div>
            </template>

            <el-form label-width="120px" class="card-form">
                <el-form-item label="用户ID">
                    <el-input v-model="formData.uid" disabled style="width: 300px" />
                </el-form-item>
                <el-form-item label="用户名">
                    <el-input v-model="formData.username" disabled style="width: 300px" />
                </el-form-item>
                <el-form-item label="密码">
                    <el-input v-model="formData.password" type="password" show-password style="width: 300px" />
                </el-form-item>
    ...
    <el-row class="row-bg" justify="center">
        <el-input v-model="redpackage" placeholder="请输入口令红包口令" style="width: 300px" />
        <el-button type="primary" @click="sendredpackage" style="margin-left: 30px">
            发送红包
        </el-button>
    </el-row>
</template>
...
.el-form-item {
    margin-bottom: 15px;
    /* Example spacing between form items */
}
