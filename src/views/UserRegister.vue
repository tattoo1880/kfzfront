                    ...
                    <el-row class="row-bg" justify="center">
                        <el-col :span="24">
                            <el-form :label-position="Top" label-width="auto" :model="formLabelAlign"
                                ...
                                <!-- 邮箱 -->
                                <el-form-item label="邮箱" class="itemxxxx" label-position="left">
                                    <el-input v-model="formLabelAlign.email" input-style="color: #409EFF;" />
                                </el-form-item>

                                <!-- 电话 -->
                                <el-form-item label="电话" class="itemxxxx" label-position="left">
                                    <el-input v-model="formLabelAlign.phone" input-style="color: #409EFF;" />
                                </el-form-item>
...
const handlereg = async () => {
    ...
    try {
        const res = await myfectch.post("/api/register", senddata
        );
        console.log(res);
